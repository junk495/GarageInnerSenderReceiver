...
#define BME_INNER_TEMP_OFFSET_C     -2.6  // Korrektur in Grad Celsius
#define BME_INNER_HUM_OFFSET_PERCENT  +9   // Korrektur in Prozentpunkten (RH)

// NEU: Einstellungen für den Taster
#define FAN_BUTTON_PIN 18 // Pin für den Taster wurde auf 18 geändert!
#define MANUAL_FAN_DURATION_MINUTES 15 // Dauer des manuellen Lüfterbetriebs in Minuten
