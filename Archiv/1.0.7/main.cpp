// =====================================================================================
// GarageLuefterregler (main.cpp) - V5.3 (Saubere Konfiguration)
// -------------------------------------------------------------------------------------
// Letzte Änderung: 2. Juli 2025 (PMK-Definition sauber in secrets.h verlagert)
...
// Der PMK-Schlüssel wird jetzt direkt und sicher in secrets.h definiert.
// =====================================================================================
...
void setup() {
  ...
  delay(1000);
  if (DEBUG1) {
    Serial.println("\n" + getTimeStamp() + " [SETUP] GarageLuefterregler V5.3 (Modular) startet...");
